...
export default {
  ...
  meta: {
    ...
    description: 'Create an elegant timeline for your wedding photography — from booking to finished gallery.',
  },
  ...
  timeline: {
    ...
    finalWhen: (sendDays) =>
      sendDays === 0 ? 'on the wedding day'
      : sendDays === 1 ? 'the day after the wedding'
  ...
  items: {
    welcome: {
      tag: 'Kick-off', title: 'Welcome to KACH Weddings',
    ...
    getToKnow: {
      tag: 'Questionnaire', dateLabel: 'After booking', weekday: 'Within a week',
    ...
    timelineQ: {
      tag: 'Questionnaire', title: 'Run-of-day questionnaire',
    ...
    plancall: {
      tag: 'Planning', title: 'Planning call',
    ...
    finalSync: {
      tag: 'Confirmation', title: 'Final run-through',
    ...
    final: {
      tag: 'Payment', title: 'Final payment due', desc: '', who: '',
    },
    gallery: {
      tag: 'Delivery', title: 'Finished gallery',
    ...
    thanks: {
      tag: 'Closing', title: 'Thank you for your trust',
  ...
  asides: {
    parfoto: {
      ...
      descIncluded: 'A dedicated photo session for the two of you — a relaxed way to grow comfortable in front of the camera. We find a good time together.',
      descOptional: 'A dedicated photo session for the two of you during the autumn or spring before the wedding — a relaxed way to grow comfortable in front of the camera.',
    ...
    album: {
      ...
      eyebrowIncluded: 'Included in the package',
      eyebrowOptional: 'Optional add-on',
      descIncluded: 'Once the gallery is ready, your favourites can be gathered into a handmade album — your story in physical form.',
      descOptional: 'Once the gallery is ready, your favourites can be gathered into a handmade album — your story in physical form.',
      noteOptional: 'Comes in addition to the package price.',
    },
  },
  ...
  csv: {
    headers: ['Couple', 'Wedding date', 'Location', 'Phase', 'Tag', 'Date', 'Weekday', 'Title', 'Description', 'Detail'],
    included: 'Included',
